...
make -C $COREVVERIF_DIR/cv32e40p/sim/core CV_SW_TOOLCHAIN=_ CV_SW_PREFIX=_ CV_CORE_PATH=$CV32E40P_DIR CV_CORE_PKG=$CV32E40P_DIR VERBOSE=1 LOG_INSNS=0 WAVES=0 testbench_verilator
